...
app.factory("Locale", function() {
	...
	Locale.langMap["cn"] = {
		...
		DOTA_UNIT_TARGET_MECHANICAL: "机械(已移除)",
		...
		DOTA_UNIT_TARGET_FLAG_DEAD: "已死亡（失效）",
		...
		DOTA_UNIT_TARGET_FLAG_NO_INVIS: "不是隐形的(失效)",
		DOTA_UNIT_TARGET_FLAG_NONE: "无（失效）",
		...
		ItemAliases: "物品别名",
		ItemStockMax: "商店最多数量",
		ItemStockTime: "商店更新时间",
		ItemStockInitial: "商店初始数量",
		...
		MODIFIER_PROPERTY_COOLDOWN_PERCENTAGE: "冷却时间百分比",
		...
		MODIFIER_PROPERTY_ALWAYS_ALLOW_ATTACK: "总是允许攻击(无限距离?)",
		...
		MODIFIER_PROPERTY_CAN_ATTACK_TREES: "可以攻击树木",
		MODIFIER_PROPERTY_VISUAL_Z_DELTA: "可视化Z差量",
